...
import { NavbarColorContext, Navbarcontext } from '../component/Navcontext'
...
const Navbarone = () => {
 ...
 const [navopen,setnavopen]=useContext(Navbarcontext)
  ...
  return (
    <div className='z-4  flex fixed top-0 w-full justify-between items-center'>
    <div className="p-5 ">
    ...
    className="h-15 mb-7 bg-black  relative w-[16vw]">
     
      <div ref={navref}  className="bg-[#D3FD50] transition-all absolute top-0 h-0 w-full"></div>
      
       <div className="relative h-full  px-12 flex flex-col items-end justify-center gap-1  ">
        <div className="lg:w-15 sm:w-5 h-0.5 bg-white"></div>
