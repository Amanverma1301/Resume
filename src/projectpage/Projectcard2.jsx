...
import wall from "../assets/blog2.jpg";
...
BLOGGING APPLICATION          </h1>

          <p className="text-gray-300 leading-8 mb-10">
           Blogging involves writing, curating, and publishing content regularly on a blog, a type of website that often presents information in chronological order with the newest content first. Blogs can focus on various topics such as personal experiences, 
           niche industries, lifestyle, travel, technology, or professional expertise.
          </p>
          ...
          shadow-[0_0_30px_rgba(139,92,246,0.6)] hover:scale-105 transition-all duration-300">
            <a href="https://amanverma1301.github.io/Drrible/" target='_blank'>
 VISIT
</a>
          </button>
        </div>
        ...
        <div className="absolute bottom-10 left-20 right-20 flex items-center gap-4">
          <div className="flex-1 h-[2px] bg-white/20 relative">
            <div className="absolute left-0 top-0 h-full w-[20%] bg-white"></div>
          </div>
