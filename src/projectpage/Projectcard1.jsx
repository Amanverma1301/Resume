...
import refokus from "../assets/refokus.mp4";
import refokus2 from "../assets/refokus2.png";
  ...
  return (
    ...
    className="relative flex flex-col md:flex-row min-h-screen  text-white">
      ...
      <div className="w-full md:w-2/3 h-screen flex flex-col overflow-y-auto custom-scroll">
                            <video muted loop autoPlay src={refokus} className="video-player"></video>
        <img src={refokus2} className="w-full h-screen object-cover" />
...
Refokus          </h1>
          ...
          <p className="text-gray-300 leading-8 mb-10">
           Refokus combines strategic thinking with creative precision to help ambitious teams translate who they are into brands people can feel. Every project begins by understanding what drives your audience and aligning it with your brand’s purpose, turning vision into emotional resonance. With a senior team and a process built for speed, Refokus crafts brands and websites 
           that feel intentional, perform beautifully, and move fast without compromise.
            <br /><br />
          </p>
          ...
          <a href="https://www.refokus.com/" target='_blank'>
 VISIT
</a>
          </button>
        </div>
        ...
        <div className="absolute bottom-10 left-20 right-20 flex items-center gap-4">
          <div className="flex-1 h-[2px] bg-white/20 relative">
            <div className="absolute left-0 top-0 h-full w-[30%] bg-white"></div>
          </div>
